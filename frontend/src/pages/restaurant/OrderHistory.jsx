...
import { Search, Calendar, Filter, Eye, CheckCircle, Clock, XCircle } from 'lucide-react';
  ...
  const orders = [
    {
      ...
      status: 'ready',
      timeline: [
        { status: 'Received', time: '19:30' },
        { status: 'Accepted', time: '19:31' },
        { status: 'Preparing', time: '19:32' },
        { status: 'Ready', time: '19:45' },
      ],
    },
    {
      id: 'D-204',
      ...
      status: 'completed',
      timeline: [
        { status: 'Received', time: '18:15' },
        { status: 'Accepted', time: '18:16' },
        { status: 'Preparing', time: '18:17' },
        { status: 'Ready', time: '18:35' },
        { status: 'Completed', time: '19:10' },
      ],
    },
    {
      id: 'P-156',
      ...
      status: 'cancelled',
      timeline: [
        { status: 'Received', time: '17:45' },
        { status: 'Cancelled', time: '17:50' },
      ],
    },
  ];
                  ...
                  <tr key={order.id} className="border-b border-neutral-100 hover:bg-neutral-50">
                    ...
                    <td className="p-4">
                      <span className={`px-3 py-1 rounded-full text-sm ${
                        order.mode === 'Delivery' ? 'bg-secondary/10 text-secondary' :
            ...
            <div className="p-6 border-b border-neutral-200">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <div>
                    <p className="font-medium">Truffle Pasta</p>
                    <p className="text-sm text-neutral-600">Extra cheese, No mushrooms</p>
                  </div>
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">Add chicken</p>
                  </div>
