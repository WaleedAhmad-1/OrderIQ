...
const Settings = () => {
  ...
  const [restaurantData, setRestaurantData] = useState({
    name: 'Gourmet Haven',
    address: '123 Restaurant St, New York, NY 10001',
    phone: '(212) 555-1234',
  ...
  const handleSave = () => {
    window.alert('Settings saved (local demo).');
  };
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
                ...
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-colors ${
                    notifications.newOrderSound ? 'bg-primary' : 'bg-neutral-300'
                  }`}
                >
                  <div className={`w-5 h-5 rounded-full bg-white transform transition-transform ${
                    notifications.newOrderSound ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
                ...
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-colors ${
                    notifications.browserNotifications ? 'bg-primary' : 'bg-neutral-300'
                  }`}
                >
                  <div className={`w-5 h-5 rounded-full bg-white transform transition-transform ${
                    notifications.browserNotifications ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
                ...
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-colors ${
                    notifications.emailSummaries ? 'bg-primary' : 'bg-neutral-300'
                  }`}
                >
                  <div className={`w-5 h-5 rounded-full bg-white transform transition-transform ${
