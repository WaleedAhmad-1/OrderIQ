            ...
            {sidebarCollapsed ? (
              ...
              <div className="flex items-center gap-2 px-4">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-neutral-900 leading-tight">Spice Symphony</span>
              ...
              {profileMenuOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-xl border border-neutral-100 py-1 z-50 animate-in fade-in slide-in-from-top-2">
                  <div className="px-4 py-2 border-b border-neutral-50">
                    <p className="text-sm font-bold text-neutral-900">Spice Symphony</p>
                    <p className="text-xs text-neutral-500">manager@spicesym.com</p>
                  </div>
